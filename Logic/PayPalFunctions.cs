...
public class NVPAPICaller
{
    ...
    public bool ShortcutExpressCheckout(string amt, ref string token, ref string retMsg)
    {
        ...
        string returnURL = "https://localhost:44396/Checkout/CheckoutReview.aspx";
        string cancelURL = "https://localhost:44396/Checkout/CheckoutCancel.aspx";

        NVPCodec encoder = new NVPCodec();
        encoder["METHOD"] = "SetExpressCheckout";
        encoder["RETURNURL"] = returnURL;
        encoder["CANCELURL"] = cancelURL;
        encoder["BRANDNAME"] = "ACME INC Sample Application";
        ...
        using (ProgTask2.Logic.ShoppingCartActions myCartOrders = new ProgTask2.Logic.ShoppingCartActions())
        {
...
public sealed class NVPCodec : NameValueCollection
{
    ...
    public string APIUsername = "sb-wgeuz6471278_api1.business.example.com";
    private string APIPassword = "LZQDXUCBSE4S8TZM";
    private string APISignature = "AJZkmbX2mPqcxW9lU6eikdfXrPZeAa8HB1nExryp0Mpmb2MwonY13hl";
}